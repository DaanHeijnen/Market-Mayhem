...
export const MEDIA_LIMITS = {
  ...
  audio: { maxBytes: 4.5 * 1024 * 1024, types: ['audio/mpeg', 'audio/mp3', 'audio/wav', 'audio/ogg', 'audio/webm', 'audio/mp4', 'audio/aac', 'audio/x-m4a'] },
} as const;
...
export function assertAcceptableMedia(kind: MediaKind, contentType: string, size: number) {
